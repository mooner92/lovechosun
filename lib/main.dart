    ...
    return Scaffold(
      ...
      body: Align(
        ...
        child: InkWell(
          ...
          child: Image.asset('assets/kakao_login-2/ko/kakao_login_large_wide.png'), // 이미지 버튼을 위한 이미지 설정
        ),
      ),
    );
  }
...
void main() {
  KakaoSdk.init(nativeAppKey: '4ad26a6e6607e15d391258da96b5edad');
  // 웹 환경에서 카카오 로그인을 정상적으로 완료하려면 runApp() 호출 전 아래 메서드 호출 필요
  WidgetsFlutterBinding.ensureInitialized();
  // runApp() 호출 전 Flutter SDK 초기화
  KakaoSdk.init(
    nativeAppKey: '4ad26a6e6607e15d391258da96b5edad',
    javaScriptAppKey: '10f718f0bce3fda97d990cbb93203f5e',
  );
  runApp(const MyApp());
}
